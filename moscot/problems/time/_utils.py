...
def beta(
    p: npt.ArrayLike, beta_max: float = 1.7, beta_min: float = 0.3, center: float = 0.25, width: float = 0.5, **kwargs
) -> npt.ArrayLike:
    return gen_logistic(p, beta_max, beta_min, center, width)


def delta(
    a: npt.ArrayLike, delta_max: float = 1.7, delta_min: float = 0.3, center: float = 0.1, width: float = 0.2, **kwargs
) -> npt.ArrayLike:
