...
class TestSpatioTemporalProblem:
    ...
    def test_solve_unbalanced(self, adata_spatio_temporal: AnnData):
        ...
        problem1 = problem1.prepare("time", spatial_key="spatial", a="left_marginals_unbalanced", b="right_marginals_unbalanced")
        problem2 = problem2.prepare("time", spatial_key="spatial", a="left_marginals_unbalanced", b="right_marginals_unbalanced")
