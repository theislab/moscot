...
from moscot._constants._constants import PlottingKeys, PlottingDefaults, AdataKeys
...
def adata_pl_cell_transition(gt_temporal_adata: AnnData) -> AnnData:
    ...
    for i, key in enumerate([PlottingDefaults.CELL_TRANSITION, "cell_transition_backward"]):
        gt_temporal_adata.uns[AdataKeys.UNS][PlottingKeys.CELL_TRANSITION][key]["transition_matrix"] = gt_temporal_adata.uns[f"cell_transition_10_105_{options[i]}"]
