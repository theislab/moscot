...
class OTResult(ABC):
    ...
    @staticmethod
    @abstractmethod
    def transport_matrix(self, pre_transport_matrix: Any) -> np.ndarray:
        """
    ...
    @staticmethod
    @abstractmethod
    def _push_forward(mass: Any, matrix: Any) -> np.ndarray:
        pass

    @staticmethod
    @abstractmethod
    def _pull_back(mass: Any, matrix: Any) -> np.ndarray:
        pass
...
class MatrixOTResult(OTResult):
    ...
    @staticmethod
    def transport_matrix(self, pre_transport_matrix: np.ndarray) -> np.ndarray:
        return pre_transport_matrix

    @staticmethod
    def _push_forward(mass: np.ndarray, matrix: np.ndarray) -> np.ndarray:
        return np.dot(mass, matrix)

    @staticmethod
    def _pull_back(mass: np.ndarray, matrix: np.ndarray) -> np.ndarray:
...
class PotentialOTResult(OTResult):
    ...
    @staticmethod
    def transport_matrix(self, pre_transport_matrix: List[np.ndarray, np.ndarray]) -> np.ndarray:
        return self._transport_matrix_from_potentials(pre_transport_matrix[0], pre_transport_matrix[1])

    @staticmethod
    def _transport_matrix_from_potentials(self, f: np.ndarray, g: np.ndarray) -> np.ndarray:
        pass  # TODO: @MUCDK implement

    @staticmethod
    def _push_forward(mass: np.ndarray, potentials: Tuple[np.ndarray, np.ndarray]) -> np.ndarray:
        pass  # TODO: @MUCDK implement

    @staticmethod
    def _pull_back(mass: np.ndarray, potentials: Tuple[np.ndarray, np.ndarray]) -> np.ndarray:
        pass  # TODO: @MUCDK implement
